    ...
    <>
      <main className="p-10">
        <div className="flex flex-row justify-between">
          <div className="flex-grow text-center m:text-xl sm:text-sm tracking-wider">
            RECIPE BOX
          </div>
          <button onClick={toggleView} className="m:mr-8 sm:m-0">
            {showBookmarks ? (
              <svg
        ...
        {showBookmarks ? (
          ...
          <div className="grid m:grid-cols-4 m:gap-3 sm:grid-cols-2 sm:gap-2">
            {recipes &&
